package mx.edu.ittepic.u3_servicios;
...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, LocationListener {
    ...
    //GoogleApiClient sera el punto de acceso a los servicios de Google Play.
        // Para la creación de este objeto se debe indicar la API a la que queremos acceder
        // y como queremos gestionar la conexión con los servicios
    ...
    //Metodo updateUI: actualiza los campos de latitud y longitud a partir de un objeto Location
